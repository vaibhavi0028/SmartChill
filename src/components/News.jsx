        ...
        <div className="p-8 bg-black">
            ...
            <div className="flex flex-wrap gap-8 justify-center">
                {newsItems.map((news, index) => (
                    <div key={index} className="bg-black border-2 border-gray-600 rounded-lg p-4 w-1/4 h-96 shadow-lg transform transition-transform duration-300 hover:translate-y-2 hover:shadow-2xl flex flex-col overflow-hidden">
