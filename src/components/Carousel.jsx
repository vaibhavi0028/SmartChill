...
const Carousel = () => {
  ...
  const [items, setItems] = useState([
    ...
    },
    {
      ...
      description:
        "Track the energy consumption of your chiller systems in real-time, with suggestions to optimize efficiency and reduce energy waste.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Control and monitor your cooling systems remotely with our SmartChill platform, offering flexibility and improved operational control.",
    },
  ]);
            ...
            >
              {index === 0 && (
                <>
                  {/* Content */}
                  <div
                    className={`w-[400px] pl-[20px] h-full flex flex-col items-center justify-center text-center text-white z-20`}
                    style={{ position: "relative" }} // Ensure the text content remains on top
                  >
                    <h2 className="text-4xl font-bold uppercase">
                      {item.name}
                    </h2>
                    <p className="mt-2 mb-5 animation-delay-300">
                      {item.description}
                    </p>
                  </div>
